...
import SpecificDislikes from "../WellnessPlan/ReGenerateWellnessPlan/SpecificDislikes";
import RelevanceToGoals from "../WellnessPlan/ReGenerateWellnessPlan/RelevanceToGoals";
import CustomizationNeeds from "../WellnessPlan/ReGenerateWellnessPlan/CustomizationNeeds";
import InitialFeedback from "../WellnessPlan/ReGenerateWellnessPlan/InitialFeedback";
...
const GiveFeedback = ({ navigation, route }: any) => {
  ...
  const onNavigate = (
    ...
    if (allQueData.length === screenIndex + 1) {
      ...
      // setSelectedQuestionData(prevData => saveQuestion(prevData));
      // saveQuestion()
    ...
    allActions.OnBoarding.ReGenerateSeekerWellnessPlan(
      ...
      .then((response: any) => {
        ...
        if (response.statusCode == 200) {
          ...
          setTimeout(() => {
            console.log("navigationString.WellnessPlan", route?.params?.from);
            navigation.navigate(navigationString.WellnessPlan, {
              data: response.data,
          ...
          console.log("response in ReGenerateSeekerWellnessPlan err", response);
  ...
  const renderScreens = () => {
    console.log("allQueData", SelectedQuestionData);
  ...
  return (
    console.log("djbhjfbdshjbfdhjbfhjdbfghj"),
    (
