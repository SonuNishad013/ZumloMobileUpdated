...
const useNotificationDetails = (connection, connectionId, userData) => {
  ...
  useEffect(() => {
    if (connection) {
      ...
      //   connection.on("ReceiveNotificationCount", (message: any) => {
      //     let data;
      //     try {
      ...
      const getChatData = async () => {
        ...
        try {
          connection.invoke("ReceiveNotificationCount", payload);
          connection.on("ReceiveNotificationCount", (res: any) => {
