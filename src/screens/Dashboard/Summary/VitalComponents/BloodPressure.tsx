...
interface Props {
  bloodPressureVitalData?: any;
}

const BloodPressure: React.FC<Props> = ({ bloodPressureVitalData }) => {
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>
        {bloodPressureVitalData?.title || "Blood Pressure"}
      </Text>
      <View style={styles.row}>
        <View style={styles.vitalContainer}>
          <Text style={styles.label}>{"Systolic"}</Text>
          <Text style={styles.value}>
            {(bloodPressureVitalData?.systolic || "--") + " mmHg"}
          </Text>
        </View>
        ...
        <View style={styles.vitalContainer}>
          ...
          <Text style={styles.value}>
            {(bloodPressureVitalData?.diastolic || "--") + " mmHg"}
          </Text>
        </View>
        ...
        <View style={styles.vitalContainer}>
          ...
          <Text style={styles.value}>
            {(bloodPressureVitalData?.heartRate || "--") + " bpm"}
          </Text>
        </View>
      </View>
      <Text
      ...
      >
        {"Last update "} {getTimeGap(bloodPressureVitalData?.createdDate)}
      </Text>
    </View>
  );
};
